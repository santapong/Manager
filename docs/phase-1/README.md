...
## Sequence at a glance — ALL SHIPPED (2026-06-10)
...
11. ✅ Ably adapter behind the existing `RealtimeService` port (inert without `ABLY_API_KEY`)

Phase 1 is feature-complete; next gate is dogfooding for a full sprint before Phase 2 (PLAN §2).
