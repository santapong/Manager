...
<p style="margin:24px 0"><a href="${escapeHtml(url)}" style="display:inline-block;background:#4a5af0;color:#fff;text-decoration:none;padding:10px 18px;border-radius:6px;font-weight:500">Accept invitation</a></p>
<p style="color:#888;font-size:13px;line-height:1.5">This invite expires in ${expiresInDays} days. Or paste this URL into your browser:<br><span style="word-break:break-all">${escapeHtml(url)}</span></p>
</body></html>`;
